...
//if (isset(($_POST['save'])&&($_POST['city']&&$_POST['job_section']&&$_POST['gender']&&$_POST['career_level']&&$_POST['experience']&&$_POST['time']&&$_POST['contact']&&$_POST['details']))){
if((isset($_POST['save'])&&($_POST['city']&&$_POST['job_section']&&$_POST['gender']&&$_POST['career_level']&&$_POST['experience']&&$_POST['time']&&$_POST['contact']&&$_POST['details']!=null))){
    $city       = $_POST['city'];
...
<form action="profile.php" method="post" class="row g-3">
 <!--   <div class="col-md-6">
  ...
  <!--  <div class="saso">
    ...
    <div class="btn">
        <button type="submit" class="btn btn-primary" name="save" value="save"> Upload Your Profile </button>
    </div>   
       <!-- <div class="btn">
           <button type="submit" class="btn btn-primary" name="update" value="update"> Update Your Profile </button>
        </div>-->
      <div class="email">
        <input type="text" class="form-control" placeholder="Email contact" aria-label="Recipient's username" aria-describedby="basic-addon2"  value="<?php echo $user_email ?>" name="contact">

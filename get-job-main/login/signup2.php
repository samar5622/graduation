...
if((isset($_POST['signup'] )&&($_POST['name']&&$_POST['email']&&$_POST['pass']&&$_POST['re_pass']!=null) )) {
    ...
    if(($pass === $re_pass)){
                   ...
                   $query = "SELECT email FROM logintwo WHERE email = '$email'";
                   $result = mysqli_query($conn,$query);
                   if ($result) {
                     if (mysqli_num_rows($result) > 0) {
                        echo "<script>"."alert('this email already found');" . "</script>";
                       
                    }
                     else {
                       //echo 'not found';
                                      db_connect(  "INSERT INTO logintwo (name,email,password,re) VALUES ('$name', '$email', '$pass','$re_pass')");
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="signup2.php" method="POST" class="register-form" id="register-form">

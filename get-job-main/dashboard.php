...
if((isset($_POST['upload'])&&($_POST['c_name']&&$_POST['city']&&$_POST['job_section']&&$_POST['c_contact']&&$_POST['c_details']!=null)))
{ $user_email = $_SESSION['email'];
    $c_name      =   $_POST['c_name'];
    $city        =   $_POST['city'];
    ...
    $query = "INSERT INTO dashboard (c_name,city,job_section,email,c_details) VALUES ('$c_name', '$city', '$job_section','$c_contact','$c_details')";
    db_connect($query);
